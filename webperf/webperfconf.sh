#!/bin/sh
set -o pipefail
WEBPERF=/tmp/ispmon/bin/webperf
PARSING_SERVER=https://webperf.catcp.research.netlab.hut.fi:2080
MAC=$(/sbin/ifconfig wlan0|awk '/HWaddr/ {print $5}'|sed -e 's/://g' -e 's/-//g'|cut -b1-12)
HTML=$(mktemp)
TARGETS=$(mktemp)
CONF=$(mktemp)
CACERT=$(mktemp)
...
TS=$(date +%s)
SIG_KEY=""
...
-----END CERTIFICATE-----
-----BEGIN CERTIFICATE-----

n0PEC6tUGAW3pW9D5qurYPUwu6f9yBZX/aXuq2GHajoPfJbJFruSIXCl
-----END CERTIFICATE-----
-----BEGIN CERTIFICATE-----
...
#DNS settings
dns.recurse=yes
dns.networkPreference=v4
dns.queryType=v4
dns.timeout=1000 2000 5000 1000 5000 7000 5000
dns.resolvconf=/etc/resolv.conf

#HTTP settings
http.persistentConnections=yes
http.pipelining=no
http.maxPipelining=3
http.maxConnections=20
http.maxDomainConnections=3
http.connectTimeout=3000
http.sendTimeout=3000
http.recvTimeout=10000
http.maxRetries=2
http.header=Cache-Control: no-cache
http.header=User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:29.0) Gecko/20100101 Firefox/29.0

#DNS statistics
stats.dns.queryName=yes
stats.dns.finalQueryName=yes
stats.dns.answerA=yes
stats.dns.answerAAAA=yes
stats.dns.answerAAAATTL=yes
stats.dns.answerATTL=yes
stats.dns.beginResolve=yes
stats.dns.dataReceived=yes
stats.dns.dataSent=yes
stats.dns.executionTime=yes
stats.dns.messagesReceived=yes
stats.dns.messagesSent=yes
stats.dns.networkTime=yes
stats.dns.nrofAnswersA=yes
stats.dns.nrofAnswersAAAA=yes
stats.dns.queries=yes
stats.dns.returnCode=yes
stats.dns.trace=yes

#HTTP statistics
stats.http.beginConnect=yes
stats.http.connectionReused=yes
stats.http.connectTime=yes
stats.http.connectTimeSSL=yes
stats.http.chunkedEncoding=yes
stats.http.date=yes
stats.http.downloadSize=yes
stats.http.downloadTime=yes
stats.http.expiryDate=yes
stats.http.header=cache-control
stats.http.header=transfer-encoding
stats.http.allHeaders=yes
stats.http.headerSize=yes
stats.http.pipelined=yes
stats.http.redirectURL=yes
stats.http.requestSent=yes
stats.http.responseCode=yes
stats.http.TCPStats=yes

test.outputFormat=2
test.timestamp=now
__EOF__

# CA cert file into the config file
echo "http.CAfile=$CACERT" >> $CONF

# Download the HTML file
echo -n "Downloading html file ..." 1>&2
HTTPSTATUS=$(curl --silent --write-out %{http_code} --output $HTML --location --insecure --user-agent "${USER_AGENT}" "${URL}" )
RETVAL=$?
if [ $RETVAL -eq 0 ] && [ $HTTPSTATUS -eq 200 ]; then
    echo "OK." 1>&2
else
    echo "Error." 1>&2
    on_exit
...
if [ ! -s "${HTML}" ]; then
    echo "Error in downloading html file" 1>&2
    on_exit
fi

# Check sum of html content
CKSUM=$(md5sum ${HTML} | cut -d " " -f 1)
if [ $? -ne 0 ]; then
    echo "Error in computing the checksum." 1>&2
    on_exit
fi

TS=$(date +%s)
SIG=$(echo -n "$URL$MAC$TS$CKSUM$SIG_KEY" | md5sum | cut -d " " -f 1)
if [ $? -ne 0 ]; then
    echo "Error in computing the signature." 1>&2
    on_exit
fi

PARSING_URL="${PARSING_SERVER}/?mainURL=$URL&MAC=${MAC}&timestamp=${TS}&checksum=${CKSUM}&signature=${SIG}"

# Submit file to parsing server
STATUSCODE=$(curl --silent --output $TARGETS --write-out %{http_code} --insecure --request POST --data-binary @${HTML} "$PARSING_URL" )
if [ $? -ne 0 ] || [ $STATUSCODE -ne 200 ]; then
    echo "Error in parsing html content." 1>&2
    on_exit
fi
echo "test.tag=${URL}" >> $CONF
echo "test.loadURLS=$TARGETS" >> $CONF
echo "Running test" 1>&2
$WEBPERF $CONF 2> /dev/null
